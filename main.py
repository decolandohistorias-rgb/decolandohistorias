...
def create_app():    
    ...
    database = "postgresql://postgres:lWsbLioIUCiOZiXWiKUFyqkOrqPpkRfQ@maglev.proxy.rlwy.net:29201/railway"

    app.config["SQLALCHEMY_DATABASE_URI"] = database

                                             #postgresql://postgres:lWsbLioIUCiOZiXWiKUFyqkOrqPpkRfQ@maglev.proxy.rlwy.net:29201/railway
    db.init_app(app)
    lm.login_view = 'login'
